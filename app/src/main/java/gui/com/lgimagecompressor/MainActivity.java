...
public class MainActivity extends AppCompatActivity implements LGImgCompressor.CompressListener{
...
//                        starCompressWithDefault(Uri.fromFile(imageFile).toString());
    ...
    @Override
    public void onCompressEnd(String imageOutPath) {
        Log.d(TAG,"onCompressEnd outPath:" + imageOutPath);
        if(imageOutPath == null)//压缩失败
            return;
